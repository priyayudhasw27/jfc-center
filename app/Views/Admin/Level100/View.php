                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Nama Admin</div>
                                    <div class="text-gray-800"><?= $adminData->nama_admin ?></div>
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Jenis Kelamin</div>
                                    <div class="text-gray-800"><?= $adminData->jenis_kelamin ?></div>
