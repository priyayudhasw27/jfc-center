            ...
            <li class="nav-item active">
                ...
                <div id="usersCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/Operator">Operator</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col">
                        ...
                        <div class="mb-2">Anda dapat melihat data operator di halaman ini.</div>
                        <div class="mb-4">
                            <a href="/Operator/NewForm" class="d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Operator Baru</a>
                        </div>
                        <hr class="mb-4">
                    </div>
                    <?php foreach ($operator as $operatorItem) : ?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="font-weight-bold text-primary text-uppercase mb-1">
                                                <?= $operatorItem->nama_operator ?></div>
                                            <hr>
                                            <div class="mb-2 font-weight-bold text-gray-800"><?= $operatorItem->nomor_hp ?></div>
                                            Alamat Email : <div class="font-weight-bold"><?= $operatorItem->email ?></div>
                                            Alamat Rumah : <div class="font-weight-bold"><?= $operatorItem->alamat ?></div>
                                            <a href="/operator/View/<?= $operatorItem->id_operator ?>"" class=" mt-4 btn btn-primary">Lihat</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
