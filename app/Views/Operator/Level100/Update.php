                            ...
                            <form id="updateForm" class="user" action="/Operator/Update" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" class="form-control" name="nomor_hp" id="nomor_hp" oninvalid="this.setCustomValidity('Wajib diisi')" oninput="this.setCustomValidity('')" placeholder="Nomor HP" value="<?= $operatorData->nomor_hp ?>"><br>
                                    </div>
                                </div>
                                <!-- Alamat -->
