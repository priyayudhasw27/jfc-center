...
<body id="page-top">
                                    ...
                                    <tbody>
                                        <?php foreach ($peserta as $pesertaItem) : ?>
                                            <tr>
                                                ...
                                                <td><?= $pesertaItem->alamat ?></td>
                                                <td><a href="/Peserta/View/<?= $pesertaItem->id_peserta ?>" class=" btn btn-block btn-info">Lihat</a></td>
                                            </tr>
                                        <?php endforeach ?>
                                    </tbody>
                                </table>
    ...
    <div class="modal fade" id="tambahPesertaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <input class="" type="text" id="oy" placeholder="Isi nomor peserta">
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-primary" href="/Authentication/Logout">Logout</a>
