...
<body class="bg-gradient-primary">
                            ...
                            <form class="user" action="/Registrasi/Save" method="post">
                                ...
                                <div id="step1">
                                    ...
                                    <div class="row justify-content-end p-2">
                                        <!-- Next Button -->
                                        <div class="">
                                            <input type="submit" class="btn btn-user btn-primary" id="step2Button" value="Selanjutnya">
                                ...
                                <div id="step2">
                                    ...
                                    <div class="row justify-content-between p-2">
                                        <!-- Back Button -->
                                        <div class="">
                                            <div class="btn btn-user btn-primary" id="step2ButtonBack">Kembali</div>
                                        </div>
                                        <!-- Next Button -->
                                        <div class="">
    ...
    <script>
        ...
        $('#step2ButtonBack').click(function(e) {
