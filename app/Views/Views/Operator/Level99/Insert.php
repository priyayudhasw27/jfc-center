                            ...
                            <form class="user" action="/Operator/Save" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input required type="text" class="form-control" name="nama_operator" id="nama_lengkap" oninvalid="this.setCustomValidity('Wajib diisi')" oninput="this.setCustomValidity('')" placeholder="Nama Lengkap">
