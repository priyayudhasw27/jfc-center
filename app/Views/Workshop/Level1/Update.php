                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <select class="form-control" name="id_instruktur[]" id="id_instruktur2">
                                            <?php if (isset($instrukturPengampu[1])) { ?>
                                                echo '<option value=<?= $instrukturPengampu[1]->id_instruktur; ?> selected><?= $instrukturPengampu[1]->nama_instruktur; ?></option>'
                                            <?php } else { ?>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <select class="form-control" name="id_instruktur[]" id="id_instruktur3">
                                            <?php if (isset($instrukturPengampu[2])) { ?>
                                                echo '<option value=<?= $instrukturPengampu[2]->id_instruktur; ?> selected><?= $instrukturPengampu[2]->nama_instruktur; ?></option>'
                                            <?php } else { ?>
                                                <option value='' selected>-pilih instruktur-</option>
                                            <?php }; ?>
                                            <?php foreach ($instrukturData as $instrukturItem) : ?>
