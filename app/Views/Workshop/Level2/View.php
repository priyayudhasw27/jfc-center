                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="row justify-content-end">
                                        <a href="/AbsensiPeserta/Scanner/<?= $workshop->id_workshop ?>" class=" d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-edit fa-sm text-white-50"></i> Absensi Peserta</a>
                                    </div>
                                </div>
                            </div>
                        </div>
