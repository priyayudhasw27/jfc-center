                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="row justify-content-end">
                                        <a href="/Workshop/UpdateForm/<?= $workshop->id_workshop ?>" class=" d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-edit fa-sm text-white-50"></i> Update Data</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <?php foreach ($instruktur as $instrukturItem) : ?>
                                        <div class="text-gray-800">- <?= $instrukturItem->nama_instruktur ?></div>
                                    <?php endforeach ?>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($peserta as $pesertaItem) : ?>
                                            <tr>
                                                <td><?= $pesertaItem->nama_peserta ?></td>
                                                <td><?= $pesertaItem->nomor_hp ?></td>
                                                <td><?php if($pesertaItem->inclass == 0 ){ echo 'Tidak Hadir';}else{ echo 'Hadir';}; ?></td>
                                            </tr>
                                        <?php endforeach ?>
                                    </tbody>
                                </table>
