            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col">
                        ...
                        <div class="mb-2">Anda dapat melihat data workshop di halaman ini.</div>
                        <div class="mb-4">
                            <a href="/Workshop/NewForm" class="d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Workshop Baru</a>
                        </div>
                        <hr class="mb-4">
                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col">
                                                    Tidak Hadir : <div class="text-danger font-weight-bold"><?= $pesertaTidakHadir[$workshopItem->id_workshop] ?> Peserta</div>
                                                </div>
                                            </div>
