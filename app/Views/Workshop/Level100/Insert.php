            ...
            <li class="nav-item active">
                ...
                <div id="eventCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/Workshop">Workshop</a>
                            ...
                            <form class="user" action="/Workshop/Insert" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="nik" class="font-weight-bold">Venue Workshop</label>
                                        <input class="form-control" type="text" name="venue" id="venue" oninvalid="this.setCustomValidity('Wajib diisi')" oninput="this.setCustomValidity('')" placeholder="Isi venue workshop">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-8">
                                        ...
                                        <select class="form-control" name="id_instruktur[]" id="id_instruktur1">
                                            <option value="" disabled selected>Pilih Instruktur 1</option>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-8">
                                        ...
                                        <select class="form-control" name="id_instruktur[]" id="id_instruktur2">
                                            <option value="" disabled selected>Pilih Instruktur 2</option>
                                            <?php foreach ($instrukturData as $instrukturItem) : ?>
                                                <option value=<?= $instrukturItem->id_instruktur ?>><?= $instrukturItem->nama_instruktur ?></option>
                                            <?php endforeach ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-8">
                                        ...
                                        <select class="form-control" name="id_instruktur[]" id="id_instruktur3">
                                            <option value="" disabled selected>Pilih Instruktur 3</option>
                                            <?php foreach ($instrukturData as $instrukturItem) : ?>
                                                <option value=<?= $instrukturItem->id_instruktur ?>><?= $instrukturItem->nama_instruktur ?></option>
                                            <?php endforeach ?>
                                        </select>
