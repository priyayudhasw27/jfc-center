            ...
            <li class="nav-item active">
                ...
                <div id="galeriCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/Galeri/GrandJuri">Grand Juri</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Galeri Grand Juri</h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/Upload/Store" enctype="multipart/form-data" method="post" id="uploadForm">
                        ...
                        <input type="hidden" name="redirectPage" value="GrandJuri">
