                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3 h3 font-weight-bold" id="keterangan"><i class="fa fa-clock"></i> Mohon tunggu,</div>
                                    <p class="mb-1 font-weight-bold" id="keterangan">Data anda masih divalidasi oleh admin.</p>
                                    <p class="mb-2" id="keterangan">Setelah admin memvalidasi data anda, anda dapat mengabsen peserta.</p>
                                </div>
                            </div>
