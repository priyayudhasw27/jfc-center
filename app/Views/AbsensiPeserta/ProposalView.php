...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-2" id="keterangan">Klik tombol mulai workshop untuk memulai workshop</div>
                                    <div class="mb-4 btn btn-primary" id="mulaiWorkshopButton">Mulai Workshop</div>
                                </div>
                            </div>
    ...
    <script>
        $('#mulaiWorkshopButton').click(function(e) {
            $.ajax({
                type: 'POST',
                url: '/AbsensiPeserta/ApprovalInstruktur',
                data: {
                    action: 'propose',
                    id_kehadiran: '<?= $kehadiranInstrukturData->id_kehadiran ?>',
                },
                dataType: 'json',
                success: function(data) {
                    if(data.result == 'success'){
                        // $('#keterangan').text('Mohon tunggu, data anda masih divalidasi oleh admin. Setelah admin memvalidasi data anda, anda dapat mengabsen peserta');
                        // $('#mulaiWorkshopButton').hide();
                        location.reload();
                    }
                }
            })
