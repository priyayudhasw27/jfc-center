            ...
            <li class="nav-item active">
                ...
                <div id="usersCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/Leader">Leader</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-end mb-4">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/Leader">Leader</a></li>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Nama Leader</div>
                                    <div class="text-gray-800"><?= $leaderData->nama_leader ?></div>
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Tema</div>
                                    <div class="text-gray-800"><?= $leaderData->nama_kategori ?></div>
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Defile</div>
                                    <div class="text-gray-800"><?= $leaderData->nama_sub_kategori ?></div>
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Jenis Kelamin</div>
                                    <div class="text-gray-800"><?= $leaderData->jenis_kelamin ?></div>
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Email</div>
                                    <div class="text-gray-800"><?= $leaderData->email ?></div>
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Nomor HP</div>
                                    <div class="text-gray-800"><?= $leaderData->nomor_hp ?></div>

                                </div>
                                <div class="col">
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Asal Sekolah / Instansi</div>
                                    <div class="text-gray-800"><?= $leaderData->asal ?></div>
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Alamat</div>
                                    <div class="text-gray-800"><?= $leaderData->alamat ?></div>
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Kecamatan</div>
                                    <div class="text-gray-800"><?= $leaderData->kecamatan ?></div>
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Kabupaten</div>
                                    <div class="text-gray-800"><?= $leaderData->kabupaten ?></div>
                                    <div class="text-gray-800 font-weight-bold mt-2 ">Provinsi</div>
                                    <div class="text-gray-800"><?= $leaderData->provinsi ?></div>
                                </div>
                            </div>
